...
const AccessibilitySettings: React.FC<AccessibilitySettingsProps> = ({ isOpen, onClose }) => {
  ...
  return (
    ...
    >
      <div className="bg-neutral-100 rounded-lg shadow-xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
        {/* Header */}
        <div className="flex items-center justify-between p-6 border-b border-neutral-200">
          <div className="flex items-center space-x-3">
            <Settings className="w-6 h-6 text-primary-600" />
            <h2 id="accessibility-title" className="text-xl font-semibold text-primary-700">
        ...
        <div className="p-6 space-y-8">
          ...
          <section>
            <h3 className="text-lg font-medium text-primary-700 mb-4 flex items-center">
              ...
              <div>
                ...
                <div className="flex items-center space-x-3">
                  <button
                    ...
                    className="flex items-center justify-center w-8 h-8 rounded-md bg-neutral-100 hover:bg-neutral-200 disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-blue-500"
                  ...
                  <button
                    ...
                    className="flex items-center justify-center w-8 h-8 rounded-md bg-neutral-100 hover:bg-neutral-200 focus:outline-none focus:ring-2 focus:ring-blue-500"
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 ${
                    preferences.soundEnabled ? 'bg-primary-600' : 'bg-neutral-200'
                  }`}
                  role="switch"
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 ${
                    preferences.autoAnnouncements ? 'bg-primary-600' : 'bg-neutral-200'
                  }`}
                  role="switch"
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 ${
                    preferences.focusIndicator ? 'bg-primary-600' : 'bg-neutral-200'
                  }`}
                  role="switch"
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 ${
                    preferences.keyboardNavigationHelp ? 'bg-primary-600' : 'bg-neutral-200'
                  }`}
                  role="switch"
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 ${
                    !preferences.animationsEnabled ? 'bg-primary-600' : 'bg-neutral-200'
                  }`}
                  role="switch"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                  <div>
                    ...
                    <ul className="mt-2 space-y-1">
                      <li><kbd className="bg-neutral-100 px-2 py-1 rounded">Tab</kbd> - Siguiente elemento</li>
                      <li><kbd className="bg-neutral-100 px-2 py-1 rounded">Shift + Tab</kbd> - Elemento anterior</li>
                      <li><kbd className="bg-neutral-100 px-2 py-1 rounded">Enter</kbd> - Activar elemento</li>
                      <li><kbd className="bg-neutral-100 px-2 py-1 rounded">Escape</kbd> - Cerrar modal/menú</li>
                    </ul>
                  </div>
                  <div>
                    <strong>Navegación por Listas:</strong>
                    <ul className="mt-2 space-y-1">
                      <li><kbd className="bg-neutral-100 px-2 py-1 rounded">↑ ↓</kbd> - Navegar elementos</li>
                      <li><kbd className="bg-neutral-100 px-2 py-1 rounded">Home</kbd> - Primer elemento</li>
                      <li><kbd className="bg-neutral-100 px-2 py-1 rounded">End</kbd> - Último elemento</li>
                      <li><kbd className="bg-neutral-100 px-2 py-1 rounded">Ctrl + F</kbd> - Buscar</li>
                    </ul>
                  </div>
                </div>
              </div>
        ...
        <div className="flex items-center justify-between p-6 border-t border-neutral-200">
          ...
          <button
            onClick={onClose}
            className="bg-primary-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors"
          >
