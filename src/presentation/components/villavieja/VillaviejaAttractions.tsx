    ...
    <div className="space-y-8">
        ...
        <div className="bg-gradient-to-r from-orange-600 to-red-600 text-white p-8">
          <div className="flex items-center space-x-4 mb-4">
            ...
            <div>
              ...
              <p className="text-orange-100">Descubre las maravillas de Villavieja</p>
            </div>
          </div>
        ...
        <div className="p-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <h3 className="font-semibold text-gray-900">330 km²</h3>
              <p className="text-sm text-gray-600">Área del desierto</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">Vista panorámica</p>
            </div>
            <div className="text-center">
              <div className="bg-green-100 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-3">
                <Globe className="w-8 h-8 text-green-600" />
              </div>
              <h3 className="font-semibold text-gray-900">13M años</h3>
              <p className="text-sm text-gray-600">Fósiles antiguos</p>
            </div>
            <div className="text-center">
              <div className="bg-amber-100 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-3">
                <Award className="w-8 h-8 text-amber-600" />
              </div>
              <h3 className="font-semibold text-gray-900">Único</h3>
              <p className="text-sm text-gray-600">En Colombia</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
        <div className="relative">
          ...
          <div className="absolute bottom-4 left-4 text-white">
            ...
            <p className="text-orange-100">El segundo desierto más grande de Colombia</p>
          </div>
        </div>
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div>
              <h4 className="text-lg font-semibold mb-3 text-gray-900">Zonas Principales</h4>
              <div className="space-y-3">
                <div className="bg-red-50 rounded-lg p-4">
                  <h5 className="font-medium text-red-800 mb-1">Zona Roja (Cusco)</h5>
                  <p className="text-red-600 text-sm">Formaciones arcillosas rojizas con paisajes surrealistas</p>
                </div>
                <div className="bg-gray-50 rounded-lg p-4">
                  <h5 className="font-medium text-gray-800 mb-1">Zona Gris (Los Hoyos)</h5>
                  <p className="text-gray-600 text-sm">Laberintos de rocas grises con senderos únicos</p>
                </div>
              </div>
            </div>

            <div>
              <h4 className="text-lg font-semibold mb-3 text-gray-900">Información Práctica</h4>
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
                  <Clock className="w-5 h-5 text-orange-600" />
                  <span className="text-gray-700">1-2 días recomendados</span>
                </div>
                <div className="flex items-center space-x-3">
                  <DollarSign className="w-5 h-5 text-green-600" />
                  <span className="text-gray-700">$15.000 COP entrada</span>
                </div>
                <div className="flex items-center space-x-3">
                  <Users className="w-5 h-5 text-blue-600" />
                  <span className="text-gray-700">Dificultad: Moderada</span>
                </div>
                <div className="flex items-center space-x-3">
                  <Calendar className="w-5 h-5 text-purple-600" />
                  <span className="text-gray-700">Mejor: Diciembre - Marzo</span>
                </div>
              </div>
            </div>
          </div>
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    ...
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      <div>
                        ...
                        <p className="font-medium text-gray-900">{attraction.bestTimeToVisit}</p>
                      </div>
                      <div>
                        <span className="text-gray-600">Tiempo sugerido:</span>
                        <p className="font-medium text-gray-900">{attraction.timeRequired}</p>
                      </div>
                    </div>
                  </div>

                  <button className="w-full bg-gradient-to-r from-orange-600 to-red-600 text-white py-3 rounded-lg hover:opacity-90 transition-opacity flex items-center justify-center space-x-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-gradient-to-br from-orange-50 to-red-50 rounded-xl p-6 border border-orange-200">
              ...
              <div className="flex items-center justify-between">
                <span className="text-orange-600 font-semibold">2 días / 1 noche</span>
                <span className="bg-orange-100 text-orange-800 px-2 py-1 rounded-full text-xs">Recomendado</span>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-indigo-50 rounded-xl p-6 border border-purple-200">
              ...
              <div className="flex items-center justify-between">
                <span className="text-purple-600 font-semibold">1 día</span>
                <span className="bg-purple-100 text-purple-800 px-2 py-1 rounded-full text-xs">Educativo</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h4 className="font-semibold text-gray-900 mb-3">Qué Llevar</h4>
