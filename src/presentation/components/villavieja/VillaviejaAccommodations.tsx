    ...
    <div className="space-y-8">
      ...
      <div className="bg-white rounded-2xl shadow-xl p-6">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center space-x-3">
            ...
            <h3 className="text-xl font-bold text-gray-900">Filtros y Ordenamiento</h3>
          </div>
          <button
        ...
        {showFilters && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pb-6 border-b">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-3">Tipo de Alojamiento</label>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        {sortedAccommodations.map((accommodation) => (
          <div key={accommodation.id} className="bg-white rounded-2xl shadow-xl overflow-hidden group hover:shadow-2xl transition-shadow">
            <div className="relative">
              ...
              <div className="absolute top-4 left-4">
                <span className={`px-3 py-1 rounded-full text-sm font-semibold ${
                  ...
                  accommodation.type === 'Glamping' ? 'bg-purple-100 text-purple-800' :
                  accommodation.type === 'Hostería' ? 'bg-green-100 text-green-800' :
                  accommodation.type === 'Casa Rural' ? 'bg-amber-100 text-amber-800' :
              ...
              <div className="mb-6">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  {accommodation.amenities.length > 6 && (
                    <span className="text-sm text-gray-500">+{accommodation.amenities.length - 6} más</span>
                  )}
                </div>
              </div>
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="bg-green-50 rounded-xl p-4 border border-green-200">
              ...
              <p className="text-2xl font-bold text-green-600 mb-1">$25.000 - $50.000</p>
            ...
            <div className="bg-blue-50 rounded-xl p-4 border border-blue-200">
              ...
              <p className="text-2xl font-bold text-blue-600 mb-1">$50.000 - $150.000</p>
              <p className="text-sm text-blue-700">Hosterías y hoteles sencillos</p>
            ...
            <div className="bg-purple-50 rounded-xl p-4 border border-purple-200">
              ...
              <p className="text-2xl font-bold text-purple-600 mb-1">$150.000 - $250.000</p>
              <p className="text-sm text-purple-700">Hoteles boutique y glamping</p>
              <ul className="mt-3 space-y-1 text-sm text-purple-600">
            ...
            <div className="bg-amber-50 rounded-xl p-4 border border-amber-200">
              ...
              <p className="text-2xl font-bold text-amber-600 mb-1">$250.000+</p>
      ...
      <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h4 className="font-semibold text-gray-900 mb-3">Mejor época para reservar</h4>
            ...
            <div>
              <h4 className="font-semibold text-gray-900 mb-3">Incluye en tu reserva</h4>
              <ul className="space-y-2 text-sm text-gray-700">
                <li className="flex items-center space-x-2">
