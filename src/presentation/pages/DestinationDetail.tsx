...
export default function DestinationDetail() {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-neutral-50 via-white to-neutral-100 flex items-center justify-center">
        <div className="text-center">
          <div className="loading-spinner w-12 h-12 border-4 border-primary-600 border-t-transparent rounded-full mx-auto mb-4"></div>
          <p className="text-neutral-600">Cargando información del destino...</p>
        </div>
      </div>
    );
  }
  ...
  if (!destination) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-neutral-50 via-white to-neutral-100 flex items-center justify-center">
        <div className="text-center">
          <Mountain className="w-16 h-16 text-neutral-400 mx-auto mb-4" />
          <h1 className="text-2xl font-bold text-neutral-900 mb-2">Destino no encontrado</h1>
          <p className="text-neutral-600 mb-4">El destino que buscas no existe o ha sido removido.</p>
          <Link
            to="/villavieja"
            ...
            <div className="flex items-center space-x-3">
              <button
                ...
                className={`p-2 rounded-full transition-colors ${
                  isFavorite ? 'bg-red-100 text-red-600' : 'bg-neutral-100 text-neutral-600 hover:text-red-600'
                }`}
              >
                <Heart className={`w-5 h-5 ${isFavorite ? 'fill-current' : ''}`} />
              </button>
              <button className="p-2 rounded-full bg-neutral-100 text-neutral-600 hover:text-primary-600 transition-colors">
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="flex items-center space-x-4 text-lg">
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-neutral-300 ml-1">({destination.totalReviews} reviews)</span>
                </div>
              </div>
            </div>
          </div>
...
function OverviewTab({ destination }: { destination: Destination }) {
  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        <h2 className="text-2xl font-bold text-neutral-900 mb-4">Sobre este destino</h2>
        <p className="text-neutral-700 text-lg leading-relaxed">{destination.description}</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-gradient-to-br from-neutral-50 to-neutral-100 rounded-xl p-6">
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center">
              ...
              <span className="text-lg font-bold text-neutral-900">{formatPrice(destination.priceRange.min)}</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-neutral-600">Hasta:</span>
              <span className="text-lg font-bold text-neutral-900">{formatPrice(destination.priceRange.max)}</span>
            </div>
        ...
        <div className="bg-gradient-to-br from-green-50 to-neutral-50 rounded-xl p-6">
          <h3 className="text-lg font-semibold text-neutral-900 mb-4 flex items-center">
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between items-center">
              <span className="text-neutral-600">Recomendado:</span>
              <span className="font-semibold text-primary-600">{destination.duration.recommended}</span>
            </div>
            <div className="pt-2 border-t border-neutral-200">
      ...
      <div className="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-xl p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="text-center">
            <div className="text-2xl font-bold text-neutral-900">{destination.weather.temperature.avg}°C</div>
            <div className="text-sm text-neutral-600">Temperatura</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-neutral-900">{destination.weather.humidity}%</div>
            <div className="text-sm text-neutral-600">Humedad</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-neutral-900">{destination.weather.precipitation}mm</div>
            <div className="text-sm text-neutral-600">Precipitación</div>
          </div>
          <div className="text-center">
            <div className="text-lg font-semibold text-neutral-900">{destination.weather.season}</div>
            <div className="text-sm text-neutral-600">Temporada</div>
          </div>
        </div>
      ...
      <div className="bg-white border border-neutral-200 rounded-xl p-6">
        ...
        <div className="space-y-4">
          <div className="flex items-start space-x-3">
            <Bus className="w-5 h-5 text-primary-600 mt-1" />
            <div>
              <div className="font-medium text-neutral-900">En Bus</div>
              <div className="text-neutral-600">{destination.howToGetThere.byBus}</div>
            </div>
          </div>
          <div className="flex items-start space-x-3">
            <Car className="w-5 h-5 text-green-600 mt-1" />
            <div>
              <div className="font-medium text-neutral-900">En Carro</div>
              <div className="text-neutral-600">{destination.howToGetThere.byCar}</div>
            </div>
          </div>
          {destination.howToGetThere.byPlane && (
            <div className="flex items-start space-x-3">
              <Plane className="w-5 h-5 text-accent-600 mt-1" />
              <div>
                <div className="font-medium text-neutral-900">En Avión</div>
                <div className="text-neutral-600">{destination.howToGetThere.byPlane}</div>
              </div>
            </div>
          )}
...
function ActivitiesTab({ activities }: { activities: Activity[] }) {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h2 className="text-2xl font-bold text-neutral-900">Actividades Disponibles</h2>
        <span className="text-sm text-neutral-600">{activities.length} actividades</span>
      </div>

      {activities.length === 0 ? (
        <div className="text-center py-12">
          <Zap className="w-16 h-16 text-neutral-400 mx-auto mb-4" />
          <h3 className="text-lg font-semibold text-neutral-900 mb-2">No hay actividades disponibles</h3>
          <p className="text-neutral-600">Las actividades para este destino estarán disponibles próximamente.</p>
        </div>
      ) : (
        <div className="grid gap-6">
          {activities.map((activity, index) => (
            <div
              key={activity.id}
              className="bg-white border border-neutral-200 rounded-xl p-6 hover:shadow-lg transition-shadow duration-300 card-hover-effect"
            ...
            >
              <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-4">
                ...
                <div className="md:text-right md:ml-6">
                  ...
                  <div className="text-sm text-neutral-600 mb-3">por persona</div>
                  <Link
                    to={`/booking/${destination.id}?type=activity&itemId=${activity.id}&startDate=${new Date().toISOString().split('T')[0]}&guests=1`}
                    className="bg-gradient-to-r from-primary-600 to-accent-600 text-white px-6 py-2 rounded-lg hover:from-primary-700 hover:to-accent-700 transition-all duration-300 shimmer-button inline-block text-center"
                  >
                    Reservar
                  </Link>
                </div>
...
function AccommodationsTab({ accommodations }: { accommodations: Accommodation[] }) {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h2 className="text-2xl font-bold text-neutral-900">Alojamientos Disponibles</h2>
        <span className="text-sm text-neutral-600">{accommodations.length} opciones</span>
      </div>

      {accommodations.length === 0 ? (
        <div className="text-center py-12">
          <Bed className="w-16 h-16 text-neutral-400 mx-auto mb-4" />
          <h3 className="text-lg font-semibold text-neutral-900 mb-2">No hay alojamientos disponibles</h3>
          <p className="text-neutral-600">Los alojamientos para este destino estarán disponibles próximamente.</p>
        </div>
      ) : (
        <div className="grid gap-6">
          {accommodations.map((accommodation, index) => (
            <div
              ...
              className="bg-white border border-neutral-200 rounded-xl overflow-hidden hover:shadow-lg transition-shadow duration-300 card-hover-effect"
              style={{ animationDelay: `${index * 0.1}s` }}
            >
                ...
                <div className="flex-1 p-6">
                  <div className="flex items-start justify-between mb-3">
                    <div>
                      ...
                      <h3 className="text-xl font-bold text-neutral-900 mb-1">{accommodation.name}</h3>
                      <div className="flex items-center mb-2">
                        <Star className="w-4 h-4 text-yellow-400 fill-current mr-1" />
                        <span className="font-semibold">{accommodation.rating.toFixed(1)}</span>
                        <span className="text-neutral-500 text-sm ml-1">({accommodation.totalReviews} reviews)</span>
                      </div>
                    </div>
                    ...
                    <div className="text-right">
                      ...
                      <div className="text-sm text-neutral-500">hasta {accommodation.maxGuests} huéspedes</div>
                    </div>
                  </div>

                  <p className="text-neutral-600 mb-4">{accommodation.description}</p>

                  <div className="mb-4">
                    <h4 className="font-semibold text-neutral-900 mb-2">Servicios incluidos</h4>
                    <div className="flex flex-wrap gap-2">
                      {accommodation.amenities.map((amenity, i) => (
                        <span
                          key={i}
                          className="bg-neutral-100 text-neutral-700 px-2 py-1 rounded-lg text-sm flex items-center"
                        >
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    {accommodation.available ? (
                      ...
                      <button
                        disabled
                        className="bg-neutral-400 text-white px-6 py-2 rounded-lg cursor-not-allowed"
                      >
                        No disponible
                      </button>
                    )}
...
function ReviewsTab({ reviews, destinationId }: { reviews: Review[], destinationId: string }) {
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h2 className="text-2xl font-bold text-neutral-900">Opiniones de Viajeros</h2>
      ...
      {reviews.length === 0 ? (
        <div className="text-center py-12">
          ...
          <h3 className="text-lg font-semibold text-neutral-900 mb-2">Sé el primero en opinar</h3>
          <p className="text-neutral-600 mb-4">Comparte tu experiencia para ayudar a otros viajeros</p>
        ...
        <div className="space-y-6">
          {reviews.map((review, index) => (
            <div
              key={review.id}
              className="bg-white border border-neutral-200 rounded-xl p-6 section-enter"
              style={{ animationDelay: `${index * 0.1}s` }}
            >
                        ...
                        <div className="flex">
                          {[1, 2, 3, 4, 5].map(star => (
                            <Star
                              key={star}
                              className={`w-4 h-4 ${
                                star <= review.rating.overall ? 'text-yellow-400 fill-current' : 'text-neutral-300'
                              }`}
                            />
                          ))}
                        </div>
...
function LocationTab({ destination }: { destination: Destination }) {
  return (
    <div className="space-y-6">
      <h2 className="text-2xl font-bold text-neutral-900">Ubicación y Mapa</h2>

      <div className="bg-neutral-200 rounded-xl h-64 md:h-96 flex items-center justify-center">
      ...
      <div className="bg-white border border-neutral-200 rounded-xl p-6">
        <h3 className="text-lg font-semibold text-neutral-900 mb-4">Información de Ubicación</h3>
        <div className="space-y-3">
          <div className="flex items-center">
            <MapPin className="w-5 h-5 text-red-600 mr-3" />
            <div>
              <div className="font-medium text-neutral-900">Dirección</div>
              <div className="text-neutral-600">{destination.location.address}</div>
            </div>
          </div>
          <div className="flex items-center">
            <Globe className="w-5 h-5 text-primary-600 mr-3" />
            <div>
              <div className="font-medium text-neutral-900">Ubicación</div>
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl shadow-lg p-6 sticky top-24">
        <div className="text-center mb-4">
          ...
          <div className="text-neutral-600">por persona</div>
        </div>

        <Link
          to={`/booking/${destination.id}?startDate=${new Date().toISOString().split('T')[0]}&guests=1`}
          className="w-full bg-gradient-to-r from-primary-600 to-accent-600 text-white py-3 rounded-xl hover:from-primary-700 hover:to-accent-700 transition-all duration-300 font-semibold mb-4 shimmer-button inline-block text-center"
        >
          Reservar Ahora
        </Link>
        ...
        <div className="space-y-3 text-sm">
          <div className="flex items-center justify-between">
            <span className="text-neutral-600">✓ Cancelación gratuita</span>
          </div>
          <div className="flex items-center justify-between">
            <span className="text-neutral-600">✓ Confirmación instantánea</span>
          </div>
          <div className="flex items-center justify-between">
      ...
      <div className="bg-white rounded-2xl shadow-lg p-6">
        <h3 className="text-lg font-semibold text-neutral-900 mb-4">¿Necesitas ayuda?</h3>
        <div className="space-y-3">
          ...
          <button className="w-full flex items-center justify-center space-x-2 bg-primary-600 text-white py-3 rounded-xl hover:bg-primary-700 transition-colors">
      ...
      {/* Tags */}
      <div className="bg-white rounded-2xl shadow-lg p-6">
        <h3 className="text-lg font-semibold text-neutral-900 mb-4">Características</h3>
        <div className="flex flex-wrap gap-2">
